            ...
            <div className="mx-auto max-w-6xl">
                ...
                >
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-foreground mb-4">
                        {t.liveConsultancy.process.title}
                    </h2>
                ...
                <div className="relative">
                    ...
                    <div className="grid gap-12 lg:grid-cols-4">
                        {t.liveConsultancy.process.steps.map((step, index) => (
                            <motion.div
                                key={index}
                            ...
                            >
                                {/* Number Circle */}
                                <div className="relative z-10 mb-8 flex h-20 w-20 items-center justify-center rounded-full border-[4px] border-background bg-card shadow-[0_0_20px_rgba(250,204,21,0.15)] transition-transform duration-300 group-hover:scale-110">
